...
#[derive(Debug)]
pub struct NextDepthProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NextDepthProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NextDepth processing");
    
    let mut processor = NextDepthProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NextDepthProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NextDepthProcessor::new(false);
